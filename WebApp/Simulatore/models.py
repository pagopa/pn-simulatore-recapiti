...
class view_tabella_sintesi_reg_recap(pg.View):
    ...
    ,
        "CTE_RECAPITISTI_LUNEDI_MESE_SUCC" AS
        (
            SELECT 
                "SIMULAZIONE_ID","PROVINCE", "REGIONE", "UNIFIED_DELIVERY_DRIVER", "PROVINCIA_RECAPITISTA",
                ((DATE_TRUNC('month', MIN("SETTIMANA_DELIVERY")) + INTERVAL '1 month')::date 
            + ((8 - EXTRACT(isodow FROM (DATE_TRUNC('month', MIN("SETTIMANA_DELIVERY")) + INTERVAL '1 month')::date))::int % 7))::date AS "LUNEDI_MESE_SUCC"
            FROM public."OUTPUT_GRAFICO_REG_RECAP"
    GROUP BY "SIMULAZIONE_ID","PROVINCE", "REGIONE", "UNIFIED_DELIVERY_DRIVER", "PROVINCIA_RECAPITISTA"
        )
    ,
        "CTE_RECAPITISTI_MESE_SUM_PRIMA_SETT_MESE_SUCC" AS
        (
            SELECT 
                public."OUTPUT_GRAFICO_REG_RECAP"."SIMULAZIONE_ID",public."OUTPUT_GRAFICO_REG_RECAP"."PROVINCE", 
    public."OUTPUT_GRAFICO_REG_RECAP"."REGIONE", 
    public."OUTPUT_GRAFICO_REG_RECAP"."UNIFIED_DELIVERY_DRIVER", 
    public."OUTPUT_GRAFICO_REG_RECAP"."PROVINCIA_RECAPITISTA",
                SUM(public."OUTPUT_GRAFICO_REG_RECAP"."COUNT_REQUEST") AS "SUM_COUNT_REQUEST_PRIMA_SETT_MESE_SUCC"
            FROM public."OUTPUT_GRAFICO_REG_RECAP"
    INNER JOIN "CTE_RECAPITISTI_LUNEDI_MESE_SUCC"
        ON public."OUTPUT_GRAFICO_REG_RECAP"."PROVINCE" = "CTE_RECAPITISTI_LUNEDI_MESE_SUCC"."PROVINCE"
            AND public."OUTPUT_GRAFICO_REG_RECAP"."SIMULAZIONE_ID" = "CTE_RECAPITISTI_LUNEDI_MESE_SUCC"."SIMULAZIONE_ID"
            AND public."OUTPUT_GRAFICO_REG_RECAP"."REGIONE" = "CTE_RECAPITISTI_LUNEDI_MESE_SUCC"."REGIONE"
            AND public."OUTPUT_GRAFICO_REG_RECAP"."UNIFIED_DELIVERY_DRIVER" = "CTE_RECAPITISTI_LUNEDI_MESE_SUCC"."UNIFIED_DELIVERY_DRIVER"
            AND public."OUTPUT_GRAFICO_REG_RECAP"."SETTIMANA_DELIVERY" > "CTE_RECAPITISTI_LUNEDI_MESE_SUCC"."LUNEDI_MESE_SUCC"
            GROUP BY public."OUTPUT_GRAFICO_REG_RECAP"."SIMULAZIONE_ID",public."OUTPUT_GRAFICO_REG_RECAP"."PROVINCE", 
    public."OUTPUT_GRAFICO_REG_RECAP"."REGIONE", public."OUTPUT_GRAFICO_REG_RECAP"."UNIFIED_DELIVERY_DRIVER", 
    public."OUTPUT_GRAFICO_REG_RECAP"."PROVINCIA_RECAPITISTA"
        )
        SELECT 
            ROW_NUMBER() OVER () AS id,
            "CTE_RECAPITISTI_MESE".*, public."OUTPUT_RESIDUI_REG_RECAP"."COUNT_RESIDUI" AS "SUM_COUNT_RESIDUI", "CTE_RECAPITISTI_MESE_SUM_PRIMA_SETT_MESE_SUCC"."SUM_COUNT_REQUEST_PRIMA_SETT_MESE_SUCC"
        FROM "CTE_RECAPITISTI_MESE"
        LEFT JOIN "CTE_RECAPITISTI_MESE_SUM_PRIMA_SETT_MESE_SUCC"
            ON "CTE_RECAPITISTI_MESE"."PROVINCE" = "CTE_RECAPITISTI_MESE_SUM_PRIMA_SETT_MESE_SUCC"."PROVINCE"
            AND "CTE_RECAPITISTI_MESE"."SIMULAZIONE_ID" = "CTE_RECAPITISTI_MESE_SUM_PRIMA_SETT_MESE_SUCC"."SIMULAZIONE_ID"
            AND "CTE_RECAPITISTI_MESE"."REGIONE" = "CTE_RECAPITISTI_MESE_SUM_PRIMA_SETT_MESE_SUCC"."REGIONE"
            AND "CTE_RECAPITISTI_MESE"."UNIFIED_DELIVERY_DRIVER" = "CTE_RECAPITISTI_MESE_SUM_PRIMA_SETT_MESE_SUCC"."UNIFIED_DELIVERY_DRIVER"
...
class view_output_capacity_setting_mock(pg.View):
    ...
    sql = """
        WITH "MOCK_PROV" AS (
        SELECT "ID_SIMULAZIONE", "DELIVERY_DATE", "PRODUCT_TYPE", "PA_ID",
                "SUDDIVISIONE_GEOGRAFICA" AS "COD_SIGLA_PROVINCIA", "MONTHLY_ESTIMATE"
        ...
        SELECT "ID_SIMULAZIONE", "DELIVERY_DATE", "PRODUCT_TYPE",
            "COD_SIGLA_PROVINCIA", SUM("MONTHLY_ESTIMATE") AS "SUM_MONTHLY_ESTIMATE"
        FROM "UNION_ALL"
        GROUP BY ("ID_SIMULAZIONE", "DELIVERY_DATE", "PRODUCT_TYPE","COD_SIGLA_PROVINCIA")
        ),
        ...
        public."DECLARED_CAPACITY"."PRODUCT_890",
        public."DECLARED_CAPACITY"."PRODUCT_AR",
        EXTRACT(MONTH FROM "SUM_SENDERLIMIT_MOCK_BY_MONTH"."DELIVERY_DATE") AS "MONTH_DELIVERY"
        FROM public."DECLARED_CAPACITY"
        LEFT JOIN "PROV_REG"
        ON "PROV_REG"."COD_SIGLA_PROVINCIA" = public."DECLARED_CAPACITY"."GEOKEY"
        ...
        AND (
        public."DECLARED_CAPACITY"."ACTIVATION_DATE_FROM" >= 
        ("SUM_SENDERLIMIT_MOCK_BY_MONTH"."DELIVERY_DATE" + ((1 - EXTRACT(DOW FROM  "SUM_SENDERLIMIT_MOCK_BY_MONTH"."DELIVERY_DATE")::int + 7) % 7) * INTERVAL '1 day')
        AND 
        public."DECLARED_CAPACITY"."ACTIVATION_DATE_FROM" <= 
        (("SUM_SENDERLIMIT_MOCK_BY_MONTH"."DELIVERY_DATE" + INTERVAL '1 month') + ((1 - EXTRACT(DOW FROM "SUM_SENDERLIMIT_MOCK_BY_MONTH"."DELIVERY_DATE" + INTERVAL '1 month')::int + 7) % 7) * INTERVAL '1 day')
        )
        ...
        SELECT "FILTERED_CAPACITY_BY_PRODUCT".*, "FILTERED_CAPACITY_BY_PRODUCT_MOCK"."SUM_MONTHLY_ESTIMATE_MOCK"
        FROM "FILTERED_CAPACITY_BY_PRODUCT"
        LEFT JOIN "FILTERED_CAPACITY_BY_PRODUCT_MOCK"
        ON "FILTERED_CAPACITY_BY_PRODUCT"."UNIFIED_DELIVERY_DRIVER" = "FILTERED_CAPACITY_BY_PRODUCT_MOCK"."UNIFIED_DELIVERY_DRIVER" 
        AND "FILTERED_CAPACITY_BY_PRODUCT"."ACTIVATION_DATE_FROM" = "FILTERED_CAPACITY_BY_PRODUCT_MOCK"."ACTIVATION_DATE_FROM" 
        AND "FILTERED_CAPACITY_BY_PRODUCT"."ACTIVATION_DATE_TO" = "FILTERED_CAPACITY_BY_PRODUCT_MOCK"."ACTIVATION_DATE_TO"
        AND "FILTERED_CAPACITY_BY_PRODUCT"."CAPACITY" = "FILTERED_CAPACITY_BY_PRODUCT_MOCK"."CAPACITY" 
        AND "FILTERED_CAPACITY_BY_PRODUCT"."PEAK_CAPACITY" = "FILTERED_CAPACITY_BY_PRODUCT_MOCK"."PEAK_CAPACITY" 
        AND "FILTERED_CAPACITY_BY_PRODUCT"."PRODUCTION_CAPACITY" = "FILTERED_CAPACITY_BY_PRODUCT_MOCK"."PRODUCTION_CAPACITY"
        AND "FILTERED_CAPACITY_BY_PRODUCT"."REGIONE" = "FILTERED_CAPACITY_BY_PRODUCT_MOCK"."REGIONE" 
        AND "FILTERED_CAPACITY_BY_PRODUCT"."COD_SIGLA_PROVINCIA" = "FILTERED_CAPACITY_BY_PRODUCT_MOCK"."COD_SIGLA_PROVINCIA" 
        AND "FILTERED_CAPACITY_BY_PRODUCT"."PROVINCIA" = "FILTERED_CAPACITY_BY_PRODUCT_MOCK"."PROVINCIA"
        AND "FILTERED_CAPACITY_BY_PRODUCT"."PRODUCT_TYPE" = "FILTERED_CAPACITY_BY_PRODUCT_MOCK"."PRODUCT_TYPE"
        AND "FILTERED_CAPACITY_BY_PRODUCT"."PRODUCT_890" = "FILTERED_CAPACITY_BY_PRODUCT_MOCK"."PRODUCT_890" 
        AND "FILTERED_CAPACITY_BY_PRODUCT"."PRODUCT_AR" = "FILTERED_CAPACITY_BY_PRODUCT_MOCK"."PRODUCT_AR" 
        AND "FILTERED_CAPACITY_BY_PRODUCT"."MONTH_DELIVERY" = "FILTERED_CAPACITY_BY_PRODUCT_MOCK"."MONTH_DELIVERY"
        )
        SELECT
        ROW_NUMBER() OVER () AS id,  
        "UNIFIED_DELIVERY_DRIVER",
